...
public class DateStartAndEnd
{
    ...
    /**
     * getTodayStartTime : get the today start time
     * */
    ...
    /**
     * getToWeekStartTime : get the current week start time
     * */
    private static LocalDateTime getToWeekStartTime() {
        return getTodayStartTime().with(ChronoField.DAY_OF_WEEK,1);
    }

    /**
     * getToMonthStartTime : get the current month start time
     * */
    private static LocalDateTime getToMonthStartTime() {
        return getTodayStartTime().withDayOfMonth(1);
    }

    /**
     * getToYearStartTime : get the current year start time
     * */
    private static LocalDateTime getToYearStartTime() {
